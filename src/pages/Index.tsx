...
import { Book, Trophy, Wand2, Swords, Crown } from "lucide-react";
...
export default function IndexPage() {
  ...
  return (
    <GameModeProvider>
      <div className="min-h-screen bg-mystic-dark relative overflow-hidden">
        {/* Particle effects */}
        <Particles
          id="tsparticles"
          init={particlesInit}
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-mystic-dark/50 to-black/80 pointer-events-none" />
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <h1 className="text-5xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-primary via-mystic-light to-accent">
              Mystic Cards
            </h1>
            <Crown className="h-12 w-12 text-primary animate-pulse hidden md:block" />
          </div>
